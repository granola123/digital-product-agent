# -*- coding: utf-8 -*-
"""
Runner script for sourcing Mexican dish photos from Wikimedia Commons.
...
if CMD == "search":
    ...
    # Uses commons.thumb_url (Wikimedia's own thumbnailer) instead of the
    # full-res original — pulling several full-res originals back-to-back
    # trips Wikimedia's 429 rate limiter (see lessons-learned.md).
    title = sys.argv[2]
    ...
    if not i:
        ...
        sys.exit(1)
    # ask for a thumbnail a bit wider than our final target so cropping still
    # has enough source resolution
    tu = None
