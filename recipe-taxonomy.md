...
1. Human review pass on all 7 drafts for recipe accuracy/authenticity (an agent wrote the 6 new ones — verify before trusting them the way the hand-refined Thai draft was)
2. Original photography/illustration for all 7 (still CC-photo/no-photo at draft stage)
3. Visual mockups + Notion templates for the 6 new cuisines (Thai already has both)
4. Etsy comparable-pricing research for the bundle as a whole, not just per-cuisine
5. Decide bundle packaging: one Etsy listing with all 7, or 7 individual listings plus a bundle upsell (the individual-listing route still preserves per-cuisine SEO surface — worth deciding deliberately rather than defaulting)
